...
class JavaGenerator(Generator):
    ...
    def _render(self, def0):
        ...
        if def0.is_enum:
            return self.templates.render(tname, enum=def0, generated_by=GENERATED_BY)
        elif def0.is_message:
            return self.templates.render(tname, message=def0, generated_by=GENERATED_BY)
        else:
            return self.templates.render(tname, interface=def0, generated_by=GENERATED_BY)
